...
public class NewUser implements Serializable,Sendable {
    ...
    public boolean equals(Object o) {
        ...
        return getID() == newUser.getID() &&
                Double.compare(newUser.getCoins(), getCoins()) == 0 &&
                Objects.equals(getName(), newUser.getName()) &&
                Objects.equals(getPassword(), newUser.getPassword()) &&
                Objects.equals(getFamily(), newUser.getFamily()) &&
                Objects.equals(getMyProducts(), newUser.getMyProducts());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getName(), getPassword(), getFamily(), getID(), getCoins(), getMyProducts());
    }
}
